...
public class ResponseDetails extends AppCompatActivity implements LocationListener, INetworkListener {
    ...
    private String responseId, requestId;
    private LatLng respondedLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String responseName = getIntent().getStringExtra(RedLifeContants.NAME);
        String responseEmail = getIntent().getStringExtra(RedLifeContants.EMAILID);
        String responsePhone = getIntent().getStringExtra(RedLifeContants.PHONE_NUMBER);
        ...
        respondedLocation = new LatLng(lat, lon);
        SupportMapFragment supportMapFragment =
                (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
        googleMap = supportMapFragment.getMap();
        googleMap.setMyLocationEnabled(true);
        googleMap.addMarker(new MarkerOptions()
                .position(respondedLocation));
        ...
        getSupportActionBar().setTitle("Response Details");
    }
    ...
    private void initMapLocation(Location location) {
        ...
        builder.include(respondedLocation);
