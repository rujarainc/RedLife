...
import com.rujara.health.redlife.activity.LoginActivity;
...
public class SessionManager {
    // Server token received from server authentication used to request further data
    public static final String SERVER_TOKEN = "serverToken";
    // Email address (make variable public to access from outside)
    public static final String EMAIL = "email";
    // Sharedpref file name
    private static final String PREF_NAME = "RedLifePref";
